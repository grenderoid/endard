  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-dark text-white">Iklan Masuk 
          <span class="badge badge-default badge-pill"><?php
          ...
          <table class="table table-bordered table-hover">
            <thead class="thead-light">
              <tr>
                ...
                <th width="30%">Judul Iklan</th>
                <th width="15%">Status</th>
                <th width="20%">Waktu Buat</th>
              </tr>
            </thead>
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td><?php echo date("G:i:s d-F-Y",strtotime($user_data['waktu_buat'])) ?></td>
                  </tr>        
              <?php
                }
              ?>
          ...
          <div class="d-flex justify-content-center">
            <ul class="pagination">
              ...
              ?>
                ...
                ?> 
                  <span class="page-link"><a href="iklan_masuk.php?page=<?php echo $LinkPrev; ?>"><i class="fa fa-angle-double-left"></i></a></span>
                <?php
                  }
                ?>
                </li>
              ...
              ?>
                  <li <?php echo $linkActive; ?>><a class="page-link" href="iklan_masuk.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
              <?php
                }
              ?>
                ...
                ?>
                  <li class="page-link"><a href="iklan_masuk.php?page=<?php echo $linkNext; ?>"><i class="fa fa-angle-double-right"></i></a></li>
                <?php
                  }
                ?>
              </li>
