  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-dark text-white">Iklan Selesai
          <span class="badge badge-default badge-pill"><?php
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Iklan Selesai</h1>
          ...
          <table class="table table-bordered table-hover">
            <thead class="thead-light">
              <tr>
                ...
                <th width="20%">Judul Iklan</th>
                <th width="8%">Gambar</th> 
                <th width="12%">Status</th>
                <th width="23%">Waktu Tayang</th>
                <th width="10%">Aksi</th>
                  </tr>
                </thead>
                <tbody>
              <?php
                ...
                $result1 = mysqli_query($conc, "SELECT * FROM transaksi INNER JOIN user_iklan ON transaksi.id_pengiklan=user_iklan.id_pengiklan INNER JOIN tayang_iklan ON transaksi.id_tayang=tayang_iklan.id_tayang INNER JOIN iklan ON transaksi.id_iklan=iklan.id_iklan WHERE transaksi.status='Selesai' ORDER BY tanggal_tayang desc LIMIT ".$limitStart.",".$limit);
                $no = $limitStart + 1;
              ...
              ?>
                  <tr>
                    ...
                    <td><?php echo date("d-F-Y",strtotime($user_data['tanggal_tayang'])) ?></td>
                    <td>
                      <a href="#"" class="btn btn-info btn-sm" type="button" data-toggle="modal" data-target="#editstatus<?php echo $user_data['id_transaksi'] ?>">Edit Status</a>
                    </td>
                  </tr>        
          ...
          <div class="d-flex justify-content-center">
            <ul class="pagination">
              ...
              ?>
                ...
                ?>
                    <span class="page-link"><a href="iklan_selesai.php?page=<?php echo $LinkPrev; ?>"><i class="fa fa-angle-double-left"></i></a></span>
                <?php
                  }
                ?>
              </li>
              ...
              ?>
                  <li <?php echo $linkActive; ?>><a class="page-link" href="iklan_selesai.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
              <?php
                }
              ?>
                ...
                ?>
                    <li class="page-link"><a href="iklan_selesai.php?page=<?php echo $linkNext; ?>"><i class="fa fa-angle-double-right"></i></a></li>
                <?php
                  }
                ?>
                </li>
