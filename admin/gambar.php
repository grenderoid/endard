...
<div class="d-flex" id="wrapper">
  ...
  <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
      ...
      <a href="#" class="list-group-item list-group-item-action bg-dark text-white">Gambar Slide</a>
  ...
  <div id="page-content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="table-responsive">
        <button type="button" class="btn btn-info btn-sm float-right" data-toggle="modal" data-target="#tambahgambar" style="margin-bottom: 2px">Tambah Gambar</button>
        <br/>
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <?php
              ...
              $result = mysqli_query($conc, "SELECT * FROM gambar_slide ORDER BY level LIMIT ".$limitStart.",".$limit);
              $no = $limitStart + 1;
            ...
            ?>                
                ...
                <tr>
                  ...
                  <td><?php echo $user_data['gambar'] ?></td>
                  <td>
                    <a href="gambar_slide/<?php echo $user_data['gambar'] ?>" class="btn btn-info btn-sm" type="button" alt="gambar" target="_blank"><i class="fa fa-picture-o fa-sm"></i></a>
                  </td>    
                  <td>
                      <a href="#" class="btn btn-danger btn-sm" type="button" data-toggle="modal" data-target="#hapusgambar<?php echo $user_data['id']?>"><i class="fa fa-trash fa-sm"></i></a>
                  </td>
                </tr>        
              
            <?php
                include 'gambar_hapus.php';
              }
            ?>
          </tbody>
        </table>
        ...
        <div class="d-flex justify-content-center">
          <ul class="pagination">
            <?php
              ...
              $result = mysqli_query($conc, "SELECT * FROM gambar_slide");        
              $JumlahData = mysqli_num_rows($result);
            ...
            ?>
                ...
                ?>
                      <span class="page-link"><a href="gambar.php?page=<?php echo $LinkPrev; ?>"><i class="fa fa-angle-double-left"></i></a></span>
                  <?php
                    }
                  ?>
                    </li>
                ...
                ?>
                    <li <?php echo $linkActive; ?>><a class="page-link" href="gambar.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                <?php
                  }
                ?>
                  ...
                  ?>
                      <li class="page-link"><a href="gambar.php?page=<?php echo $linkNext; ?>"><i class="fa fa-angle-double-right"></i></a></li>
                  <?php
                    }
                  ?>
                  </li>
