...
<head>
  ...
  <title>Iklan dari Pengiklan</title>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="pengiklan.php" class="list-group-item list-group-item-action bg-dark text-white">Pengiklan
          <span class="badge badge-default badge-pill"><?php
      ...
      <div class="container-fluid">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              <?php
                ...
                $result1 = mysqli_query($conc, "SELECT * FROM transaksi INNER JOIN user_iklan ON transaksi.id_pengiklan=user_iklan.id_pengiklan INNER JOIN tayang_iklan ON transaksi.id_tayang=tayang_iklan.id_tayang INNER JOIN iklan ON transaksi.id_iklan=iklan.id_iklan WHERE transaksi.id_pengiklan='$id_pengiklan' ORDER BY id_transaksi desc LIMIT ".$limitStart.",".$limit); 
                $no = $limitStart + 1;
              ...
              ?>
                  <tr>";
                    ...
                    <td><?php echo $user_data['waktu_buat'] ?></td>
                  </tr>";        
              <?php
                }
              ?>
        ...
        <nav>
          <div class="d-flex justify-content-center">
            <ul class="pagination">
              <?php
                $result = mysqli_query($conc, "SELECT * FROM transaksi INNER JOIN user_iklan ON transaksi.id_pengiklan=user_iklan.id_pengiklan INNER JOIN tayang_iklan ON transaksi.id_tayang=tayang_iklan.id_tayang INNER JOIN iklan ON transaksi.id_iklan=iklan.id_iklan WHERE transaksi.id_pengiklan='$id_pengiklan' ORDER BY id_transaksi desc");
                $JumlahData = mysqli_num_rows($result);
              ...
              ?>
                  <span class="page-link"><a href="pengiklan_iklan.php?page=<?php echo $LinkPrev; ?>"><i class="fa fa-angle-double-left"></i></a></span>
              <?php
                }
              ?>
                </li>
              ...
              ?>
                  <li <?php echo $linkActive; ?>><a class="page-link" href="pengiklan_iklan.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
              <?php
                }
              ?>
              ...
              ?>
                  <li class="page-link"><a href="pengiklan_iklan.php?page=<?php echo $linkNext; ?>"><i class="fa fa-angle-double-right"></i></a></li>
              <?php
                }
              ?>
                </li>
